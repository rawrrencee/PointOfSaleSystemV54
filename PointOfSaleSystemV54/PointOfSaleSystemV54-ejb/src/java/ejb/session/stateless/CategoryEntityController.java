...
@Remote(CategoryEntityControllerRemote.class)

public class CategoryEntityController implements CategoryEntityControllerLocal, CategoryEntityControllerRemote
{
